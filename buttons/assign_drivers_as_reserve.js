...
module.exports = {
    customID: 'assign_drivers_as_reserve',
    ...
    async execute(interaction, client) {
        try {
            ...
            // Assign drivers as RESERVE (is_reserve = true)
            for (const driverId of cache.selectedDriverIds) {
                await F1Database.assignDriverToTeam(cache.seasonId, driverId, cache.selectedTeamId, true);
            }
            ...
            client.logs.error(`[assign_drivers_as_reserve] ${error.message}`);
